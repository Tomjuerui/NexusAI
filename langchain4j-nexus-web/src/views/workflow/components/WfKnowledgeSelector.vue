...
/**
 * 1. 初始化选中项不存在，指定下拉列表的第一个为选中�? * 2. 初始化选中项存在，检查选中项是否在下拉列表中，没有则请求一次该选中的知识库详情，追回到下拉列表�? */
...
<template>
  <NSelect
    ref="selectInstRef" v-model:value="selectedKnowledgeUuid" filterable placeholder="搜索知识�? :options="options"
