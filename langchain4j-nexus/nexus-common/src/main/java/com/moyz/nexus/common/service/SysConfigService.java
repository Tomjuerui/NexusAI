...
import com.moyz.nexus.common.dto.SysConfigDto;
import com.moyz.nexus.common.dto.SysConfigEditDto;
import com.moyz.nexus.common.dto.SysConfigSearchReq;
import com.moyz.nexus.common.entity.SysConfig;
...
import com.moyz.nexus.common.mapper.SysConfigMapper;
...
public class SysConfigService extends ServiceImpl<SysConfigMapper, SysConfig> {
    ...
    public void loadAndCache() {
        ...
        LocalCache.TEXT_RATE_LIMIT_CONFIG = JsonUtil.fromJson(LocalCache.CONFIGS.get(NexusConstant.SysConfigKey.REQUEST_TEXT_RATE_LIMIT), RequestRateLimit.class);
        LocalCache.IMAGE_RATE_LIMIT_CONFIG = JsonUtil.fromJson(LocalCache.CONFIGS.get(NexusConstant.SysConfigKey.REQUEST_IMAGE_RATE_LIMIT), RequestRateLimit.class);
    ...
    public int getConversationMaxNum() {
        String maxNum = LocalCache.CONFIGS.get(NexusConstant.SysConfigKey.CONVERSATION_MAX_NUM);
