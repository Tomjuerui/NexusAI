 ...
 * 增加支持：缓存命中的向量以便后续记录到数据库�?
 */
@Slf4j
public class NexusEmbeddingStoreContentRetriever implements ContentRetriever {
    ...
    public NexusEmbeddingStoreContentRetriever(EmbeddingStore<TextSegment> embeddingStore,
    ...
    private NexusEmbeddingStoreContentRetriever(String displayName,
        ...
        this.embeddingModel = ensureNotNull(
                getOrDefault(embeddingModel, NexusEmbeddingStoreContentRetriever::loadEmbeddingModel),
                "embeddingModel"
        );
    ...
    public static NexusEmbeddingStoreContentRetriever.NexusEmbeddingStoreContentRetrieverBuilder builder() {
        return new NexusEmbeddingStoreContentRetriever.NexusEmbeddingStoreContentRetrieverBuilder();
    }

    public static class NexusEmbeddingStoreContentRetrieverBuilder {
        ...
        NexusEmbeddingStoreContentRetrieverBuilder() {
        }

        public NexusEmbeddingStoreContentRetriever.NexusEmbeddingStoreContentRetrieverBuilder maxResults(Integer maxResults) {
            if (maxResults != null) {
        ...
        public NexusEmbeddingStoreContentRetriever.NexusEmbeddingStoreContentRetrieverBuilder minScore(Double minScore) {
            if (minScore != null) {
        ...
        public NexusEmbeddingStoreContentRetriever.NexusEmbeddingStoreContentRetrieverBuilder filter(Filter filter) {
            if (filter != null) {
        ...
        public NexusEmbeddingStoreContentRetriever.NexusEmbeddingStoreContentRetrieverBuilder displayName(String displayName) {
            this.displayName = displayName;
            return this;
        }

        public NexusEmbeddingStoreContentRetriever.NexusEmbeddingStoreContentRetrieverBuilder embeddingStore(EmbeddingStore<TextSegment> embeddingStore) {
            this.embeddingStore = embeddingStore;
            return this;
        }

        public NexusEmbeddingStoreContentRetriever.NexusEmbeddingStoreContentRetrieverBuilder embeddingModel(EmbeddingModel embeddingModel) {
            this.embeddingModel = embeddingModel;
            return this;
        }

        public NexusEmbeddingStoreContentRetriever.NexusEmbeddingStoreContentRetrieverBuilder dynamicMaxResults(Function<Query, Integer> dynamicMaxResults) {
            this.dynamicMaxResults = dynamicMaxResults;
            return this;
        }

        public NexusEmbeddingStoreContentRetriever.NexusEmbeddingStoreContentRetrieverBuilder dynamicMinScore(Function<Query, Double> dynamicMinScore) {
            this.dynamicMinScore = dynamicMinScore;
            return this;
        }

        public NexusEmbeddingStoreContentRetriever.NexusEmbeddingStoreContentRetrieverBuilder dynamicFilter(Function<Query, Filter> dynamicFilter) {
            this.dynamicFilter = dynamicFilter;
            return this;
        }

        public NexusEmbeddingStoreContentRetrieverBuilder breakIfSearchMissed(boolean breakIfSearchMissed) {
            this.breakIfSearchMissed = breakIfSearchMissed;
            return this;
        }

        public NexusEmbeddingStoreContentRetriever build() {
            return new NexusEmbeddingStoreContentRetriever(this.displayName, this.embeddingStore, this.embeddingModel, this.dynamicMaxResults, this.dynamicMinScore, this.dynamicFilter, this.breakIfSearchMissed);
        }


        public String toString() {
            return "NexusEmbeddingStoreContentRetriever.NexusEmbeddingStoreContentRetrieverBuilder(displayName=" + this.displayName + ", embeddingStore=" + this.embeddingStore + ", embeddingModel=" + this.embeddingModel + ", dynamicMaxResults=" + this.dynamicMaxResults + ", dynamicMinScore=" + this.dynamicMinScore + ", dynamicFilter=" + this.dynamicFilter + ", breakIfSearchMissed=" + this.breakIfSearchMissed + ")";
        }
    }
     ...
     */
    public static NexusEmbeddingStoreContentRetriever from(EmbeddingStore<TextSegment> embeddingStore) {
    ...
    @Override
    public String toString() {
        return "NexusEmbeddingStoreContentRetriever{" +
