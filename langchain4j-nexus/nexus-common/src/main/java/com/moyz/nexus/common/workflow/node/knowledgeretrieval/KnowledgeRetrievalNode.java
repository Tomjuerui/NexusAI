package com.moyz.nexus.common.workflow.node.knowledgeretrieval;
...
import static com.moyz.nexus.common.cosntant.NexusConstant.RAG_RETRIEVE_MIN_SCORE_DEFAULT;
...
public class KnowledgeRetrievalNode extends AbstractWfNode {
    ...
    public NodeProcessResult onProcess() {
        ...
        RetrieverCreateParam kbRetrieveParam = RetrieverCreateParam.builder()
                .filter(new IsEqualTo(NexusConstant.MetadataKey.KB_UUID, kbUuid))
