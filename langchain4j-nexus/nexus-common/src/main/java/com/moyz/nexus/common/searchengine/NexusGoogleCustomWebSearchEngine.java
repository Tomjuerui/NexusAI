...
/**
 * 增加支持代理
 * 从dev.langchain4j.web.search.google.customsearch.GoogleCustomWebSearchEngine复制
 ...
 */
public class NexusGoogleCustomWebSearchEngine implements WebSearchEngine {

    private final NexusGoogleCustomSearchApiClient googleCustomSearchApiClient;
     ...
     */
    @Builder
    public NexusGoogleCustomWebSearchEngine(String apiKey,
                                          String csi,
        ...
        this.googleCustomSearchApiClient = NexusGoogleCustomSearchApiClient.builder()
                .apiKey(apiKey)
                .csi(csi)
     ...
     */
    public static NexusGoogleCustomWebSearchEngine withApiKeyAndCsi(String apiKey, String csi) {
        return NexusGoogleCustomWebSearchEngine.builder().apiKey(apiKey).csi(csi).build();
    }
    ...
    private static Map<String, String> toResultMetadataMap(Result result, boolean searchTypeImage) {
        ...
        // Web search type
        if (null != result.getPagemap() && !result.getPagemap().isEmpty()) {
