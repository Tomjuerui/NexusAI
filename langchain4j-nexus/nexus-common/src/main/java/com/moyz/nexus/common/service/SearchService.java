...
import com.moyz.nexus.common.dto.AiSearchReq;
...
import com.moyz.nexus.common.entity.AiSearchRecord;
...
import static com.moyz.nexus.common.cosntant.NexusConstant.RetrieveContentFrom.WEB;
import static com.moyz.nexus.common.cosntant.NexusConstant.SSE_TIMEOUT;
import static com.moyz.nexus.common.enums.ErrorEnum.B_NO_ANSWER;
...
public class SearchService {
    ...
    public void asyncSearch(User user, SseEmitter sseEmitter, AiSearchReq req) {
        ...
        try {
            sseEmitter.send(SseEmitter.event().name(NexusConstant.SSEEventName.AI_SEARCH_SOURCE_LINKS).data(searchResult.getItems()));
        } catch (IOException e) {
            sendFail = true;
    ...
    public void detailSearch(User user, String searchText, String engineName, String modelPlatform, String modelName, List<SearchReturnWebPage> resultItems, SseEmitter sseEmitter) {
            ...
            mainExecutor.execute(() -> {
                try {
                    ...
                    if (StringUtils.isNotBlank(content)) {
                        ...
                        metadata.put(NexusConstant.MetadataKey.ENGINE_NAME, engineName);
                        metadata.put(NexusConstant.MetadataKey.SEARCH_UUID, searchUuid);
        ...
        RetrieverCreateParam createParam = RetrieverCreateParam.builder()
                .filter(new IsEqualTo(NexusConstant.MetadataKey.SEARCH_UUID, searchUuid))
