package com.moyz.nexus.common.languagemodel.wanx;
...
import static com.moyz.nexus.common.cosntant.NexusConstant.W_FAILED;
import static com.moyz.nexus.common.util.ImageUtil.imageUrl;
import static com.moyz.nexus.common.util.ImageUtil.imagesFrom;
 ...
 */
@Slf4j
public class NexusWanxImageModel implements ImageModel {
    ...
    public NexusWanxImageModel(
        ...
        this.imageSynthesis =
                Utils.isNullOrBlank(baseUrl) ? new NexusImageSynthesis(this.task, this.function) : new NexusImageSynthesis(this.task, this.function, baseUrl);
    }
    ...
    public static class WanxImageModelBuilder {
        ...
        public NexusWanxImageModel build() {
            return new NexusWanxImageModel(baseUrl, apiKey, modelName, task, function, seed, size, negativePrompt);
        }
    }
