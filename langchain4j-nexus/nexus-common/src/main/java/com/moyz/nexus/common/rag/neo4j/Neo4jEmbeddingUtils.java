...
class Neo4jEmbeddingUtils {
    ...
    public static EmbeddingMatch<TextSegment> toEmbeddingMatch(NexusNeo4jEmbeddingStore store, Record neo4jRecord) {
    ...
    public static Map<String, Object> toRecord(
            NexusNeo4jEmbeddingStore store,
            int idx,
            List<String> ids,
    ...
    public static Stream<List<Map<String, Object>>> getRowsBatched(
            NexusNeo4jEmbeddingStore store, List<String> ids, List<Embedding> embeddings, List<TextSegment> embedded) {
