...
import com.moyz.nexus.common.entity.KnowledgeBaseEmbedding;
import com.moyz.nexus.common.mapper.KnowledgeBaseEmbeddingMapper;
...
public class KnowledgeEmbeddingService extends ServiceImpl<KnowledgeBaseEmbeddingMapper, KnowledgeBaseEmbedding> implements IKnowledgeEmbeddingService {
    ...
    public Page<KbItemEmbeddingDto> listByItemUuid(String kbItemUuid, int currentPage, int pageSize) {
        Page<KnowledgeBaseEmbedding> sourcePage = baseMapper.selectByItemUuid(new Page<>(currentPage, pageSize), kbItemUuid, NexusPropertiesUtil.EMBEDDING_TABLE_SUFFIX);
    ...
    public boolean deleteByItemUuid(String kbItemUuid) {
        return baseMapper.deleteByItemUuid(kbItemUuid, NexusPropertiesUtil.EMBEDDING_TABLE_SUFFIX);
    }

    @Override
    public Integer countByKbUuid(String kbUuid) {
        return baseMapper.countByKbUuid(kbUuid, NexusPropertiesUtil.EMBEDDING_TABLE_SUFFIX);
    }
}
