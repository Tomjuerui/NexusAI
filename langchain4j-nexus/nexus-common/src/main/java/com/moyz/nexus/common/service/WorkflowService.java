...
import com.moyz.nexus.common.dto.TmpNode;
import com.moyz.nexus.common.dto.workflow.WfEdgeReq;
import com.moyz.nexus.common.dto.workflow.WfNodeDto;
import com.moyz.nexus.common.dto.workflow.WorkflowResp;
import com.moyz.nexus.common.dto.workflow.WorkflowUpdateReq;
...
import com.moyz.nexus.common.mapper.WorkflowMapper;
import com.moyz.nexus.common.util.*;
import com.moyz.nexus.common.workflow.WfComponentNameEnum;
import com.moyz.nexus.common.workflow.def.WfNodeParamRef;
import com.moyz.nexus.common.workflow.node.classifier.ClassifierNodeConfig;
import com.moyz.nexus.common.workflow.node.switcher.SwitcherCase;
import com.moyz.nexus.common.workflow.node.switcher.SwitcherNodeConfig;
...
import static com.moyz.nexus.common.enums.ErrorEnum.A_OPT_TOO_FREQUENTLY;
    ...
    private void updateNodeConfigToNewNode(TmpNode tmpNode, List<TmpNode> tmpNodes) {
        ...
        if (wfComponent.getName().equals(WfComponentNameEnum.CLASSIFIER.getName())) {
            ...
            if (null == classifierNodeConfig || CollectionUtils.isEmpty(classifierNodeConfig.getCategories())) {
                log.warn("找不到问题分类器的配�?new uuid:{},old uuid:{}", tmpNode.getNewUuid(), tmpNode.getOldUuid());
                return;
            }
