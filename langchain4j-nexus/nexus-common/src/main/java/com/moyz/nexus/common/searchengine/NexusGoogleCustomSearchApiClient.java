 ...
 */
class NexusGoogleCustomSearchApiClient {

    private static final Logger LOGGER = LoggerFactory.getLogger(NexusGoogleCustomSearchApiClient.class);
    ...
    @Builder
    NexusGoogleCustomSearchApiClient(String apiKey,
                                   String csi,
