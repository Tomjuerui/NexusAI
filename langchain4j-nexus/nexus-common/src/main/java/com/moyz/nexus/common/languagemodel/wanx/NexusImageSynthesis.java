...
public final class NexusImageSynthesis {
     ...
     */
    public NexusImageSynthesis(String task, String function) {
        // only support http
        asyncApi = new AsynchronousApi<HalfDuplexServiceParam>();
        createServiceOptions =
                ApiServiceOption.builder()
     ...
     */
    public NexusImageSynthesis(String task, String function, String baseUrl) {
        // only support http
        asyncApi = new AsynchronousApi<HalfDuplexServiceParam>();
        createServiceOptions =
                ApiServiceOption.builder()
