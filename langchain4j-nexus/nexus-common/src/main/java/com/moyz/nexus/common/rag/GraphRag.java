...
import com.moyz.nexus.common.entity.KnowledgeBaseGraphSegment;
...
import com.moyz.nexus.common.service.KnowledgeBaseGraphSegmentService;
import com.moyz.nexus.common.service.UserDayCostService;
...
import static com.moyz.nexus.common.cosntant.NexusConstant.RAG_MAX_SEGMENT_SIZE_IN_TOKENS;
        ...
        GraphStoreIngestor ingestor = GraphStoreIngestor.builder()
                ...
                .segmentsFunction(segments -> {
                    ...
                    for (TextSegment segment : segments) {
                        ...
                        graphSegment.setKbUuid(segment.metadata().getString(NexusConstant.MetadataKey.KB_UUID));
                        graphSegment.setKbItemUuid(segment.metadata().getString(NexusConstant.MetadataKey.KB_ITEM_UUID));
                        ...
                        if (StringUtils.isNotBlank(segment.text())) {
                            ...
                            log.info("请求LLM从文本中抽取实体及关�?segmentId:{}", segmentId);
